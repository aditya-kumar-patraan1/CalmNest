          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p
                ...
                ref={headRef}
              >
                Get a glimpse into how expert teachers incorporate mindfulness
                into real-life situations like parenting, running, and even
                dishwashing. Explore actionable practices that bring mindfulness
                into daily moments, making it easy to connect with your practice
                in the midst of your busy life.
              </p>
              <button
                className="bg-white block mx-0 border border-black text-black px-5 p-3 text-sm rounded-full w-fit h-auto  hover:text-white hover:bg-black font-bold cursor-pointer hover:shadow shadow-gray-500 transition-all duration-300"
                onClick={() => window.open("/BlogTop", "__blank")}
              >
                Learn for free
              </button>
            </div>
