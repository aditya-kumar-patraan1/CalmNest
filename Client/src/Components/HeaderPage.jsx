...
export default function HeaderPage() {
  ...
  const { userData, BACKEND_URL, setisLoggedIn,isLoggedIn } = useAppContext();
  ...
  const handleLogout = async () => {
    try {
      const res = await axios.delete(`${BACKEND_URL}/api/v1/logout`, {
      ...
      toast.error("User failed to logout");
    }
  };
  ...
  const navItems = [
    ...
    { href: "/MentalHealthDashboard", label: "Dashboard" },
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
            <div className="hero-content space-y-8" ref={headRef}>
              ...
              <h1 className="text-5xl font-extrabold tracking-tight text-slate-900 sm:text-7xl leading-[1.1]">
                Your Safe Space <br />
                <span className="bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent italic font-serif">
                  for Mindfulness.
                </span>
              </h1>
              ...
              <p className="text-lg text-slate-500 max-w-lg leading-relaxed">
                Experience the power of guided meditation and real-time support.
                We help you navigate daily stress with scientifically backed
                tools.
              </p>
